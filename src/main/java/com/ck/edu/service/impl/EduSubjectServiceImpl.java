...
import com.ck.edu.entity.subject.TwoSubject;
import com.ck.edu.listener.SubjectExcelListener;
import com.ck.edu.mapper.EduSubjectMapper;
...
public class EduSubjectServiceImpl extends ServiceImpl<EduSubjectMapper, EduSubject> implements EduSubjectService {
    ...
    public void importSubjectData(MultipartFile file, EduSubjectService eduSubjectService) {
        try {
            ...
            //调用方法进行读取
            EasyExcel.read(in, EduSubjectData.class,new SubjectExcelListener(eduSubjectService)).sheet().doRead();
        }catch(Exception e){
            e.printStackTrace();
        }
    }
